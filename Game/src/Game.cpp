...

{
	...
	m_regionManager.addRegion(COLLISIONABLE, 850.0f, 500.0f, 900.0f, 500.0f, m_Background, this);
	m_regionManager.addRegion(DESTRUCTEUR, 120.0f, 130.0f, 90.0f, 50.0f, m_Background, this);
